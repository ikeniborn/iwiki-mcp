...
- [x] **Step 2: HUMAN CHECKPOINT — merge**
...
- [x] **Step 1: Write the failing truthful-dirty test**
...
- [x] **Step 3: Implement the helper and route every dirty writer through it**
...
- [x] **Step 4: Run the slice tests, then the guard rails**
...
- [x] **Step 6: Version bump, docs, commit**
...
- [x] **Step 7: PR + HUMAN CHECKPOINT — merge**
...
- [x] **Step 4: Latency bound (closes spec finding F-001)**
...
- [x] **Step 5: Full verification, docs, PR**
...
- [x] **Step 4: Full verification, docs, PR**
...
- [x] **Step 4: Verification incl. PostgreSQL**
...
- [x] **Step 1: Acceptance run against a real snapshot**
