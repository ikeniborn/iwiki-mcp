...
- `README.md`, `docs/README.ru.md`, `pyproject.toml`, `uv.lock`: user contract and patch version.
...
- [ ] **Step 1: Write the successful request test**
...
- [ ] **Step 2: Write all failure tests**
...
- [ ] **Step 1: Write startup-order and expected-failure tests**
...
- [ ] **Step 2: Write help and unexpected-error tests**
...
- [ ] **Step 4: Implement orchestration and diagnostic**
...
- [ ] **Step 5: Verify unit GREEN and expected smoke RED, then commit**
...
- [ ] **Step 2: Route subprocess env and assert one request**
...
- [ ] **Step 1: Document the startup contract**
...
- [ ] **Step 2: Bump and lock version**

Change project version `0.6.9` to `0.6.10`, then:
...
- [ ] **Step 3: Verify repository docs and version**
...
- [ ] **Step 4: Update iwiki through MCP tools**
...
- [ ] **Step 5: Commit repository docs/version**

```bash
git add README.md docs/README.ru.md pyproject.toml uv.lock
...
- [ ] **Step 2: Run lint, CLI, version, and diff checks**
...
- [ ] **Step 3: Verify observable intent outcomes**
...
- [ ] **Step 4: Run result reconciliation**
...
- [ ] **Step 5: Commit final chain bookkeeping**
